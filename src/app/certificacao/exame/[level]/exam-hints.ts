export const EXAM_HINTS: string[] = [
  "Na POG a gente não pensa muito. Aqui na Academy, pensar um pouquinho é permitido (e até recomendado).",
  "A primeira opção nem sempre é a que 'veio à mente'. Ou será que é? Leia todas antes de decidir.",
  "Se estivesse em modo POG você já teria clicado em qualquer uma. Respira e escolhe com calma.",
  "Dica de ouro: uma das alternativas costuma ser a antítese do que a POG prega. Elimine as que são 'a forma errada'.",
  ...
  "POG = 'a forma errada, só que mais rápida'. A alternativa correta é a que não é isso.",
...
const QUESTION_SUBTITLES: string[] = [
  ...
  "POG seria já ter enviado. Você está fazendo certo.",
];
