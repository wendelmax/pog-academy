...
export const metadata = {
  title: "Princípios POG | POG Academy",
  description:
    "Lista dos princípios da Programação Orientada a Gambiarra com contraste às práticas recomendadas.",
};
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-12">
      ...
      <p className="mt-4 text-neutral-600 dark:text-neutral-400">
        Cada princípio descreve uma prática POG. Em contraste, indicamos a
        prática recomendada para não repetir o erro e manter produtividade
        sustentável em POC, MVP e projetos ágeis. O Livro POG (livropog.com.br)
        traz o capítulo Princípios com nomes como Documentação Espartana,
        Imperativo Funcional e Redireção Tangencial; quando há correspondência,
        o nome no livro aparece abaixo do título.
      </p>
              ...
              <div className="min-w-0 flex-1">
                ...
                {a.nomeLivro && (
                  <p className="mt-1 text-xs font-medium uppercase tracking-wide text-neutral-500 dark:text-neutral-400">
                    No Livro POG: {a.nomeLivro}
                  </p>
                )}
                <p className="mt-2 text-neutral-600 dark:text-neutral-400">
                  {a.descricao}
                </p>
                <div className="mt-4 rounded-lg border-l-4 border-orange-500 bg-orange-50/50 py-2 pl-4 dark:bg-orange-950/30">
