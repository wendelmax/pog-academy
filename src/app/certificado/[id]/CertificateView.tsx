...
> = {
  foundation: {
    border: "border-orange-600/40 dark:border-orange-400/30",
...
export default function CertificateView({
  ...
  return (
    <div className="space-y-8">
      ...
      >
        <div className="absolute inset-0 pointer-events-none rounded-[inherit] border border-amber-200/50 dark:border-amber-800/30" />
      ...
      <div className="rounded-xl border border-neutral-200 bg-neutral-50 p-6 dark:border-neutral-800 dark:bg-neutral-900/50">
        ...
        <div className="mt-4 flex flex-wrap items-center gap-3">
          <a
            ...
            download={`POG-Academy-${certificate.certificateId}.pdf`}
            className="inline-flex items-center rounded-lg bg-neutral-900 px-4 py-2.5 text-sm font-medium text-white hover:bg-neutral-700 dark:bg-orange-600 dark:hover:bg-orange-500"
          >
            Baixar certificado (PDF)
          </a>
          <LinkedInIntegration
            certificateId={certificateId}
            credentialName={`${certificate.levelName} - POG Academy`}
          />
          <Link
            href="/badges"
