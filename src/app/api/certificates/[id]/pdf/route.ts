...
export async function GET(
  ...
  try {
    const sealPath = path.join(process.cwd(), "public", "pog-certificacao-badge.png");
  ...
  doc.setFontSize(10);
  doc.text("POG ACADEMY", margin + 10, margin + 9);
  ...
  doc.setFont("helvetica", "bold");
  doc.setFontSize(18);
  doc.text(`POG ${levelLabel}`, centerX, 115, { align: "center" });

  doc.setTextColor(80, 80, 80);
  doc.setFont("helvetica", "normal");
  doc.setFontSize(11);
  doc.text("Issued by POG Academy – Programação Orientada a Gambiarra", centerX, 128, { align: "center" });
  ...
  return new NextResponse(blob, {
    ...
    headers: {
      ...
      "Content-Disposition": `attachment; filename="POG-Academy-${cert.certificateId}.pdf"`,
    },
  });
}
