        ...
        >
          ...
          <div className="relative z-10 w-full max-w-md rounded-2xl border border-neutral-200 bg-white p-6 shadow-xl dark:border-neutral-700 dark:bg-neutral-900">
            ...
            <ol className="mt-3 list-inside list-decimal space-y-2 text-sm text-neutral-600 dark:text-neutral-400">
              ...
              <li>Preencha: Nome = {credentialName}, Organização = POG Academy, URL da credencial = (cole a URL copiada).</li>
              <li>Salve.</li>
            </ol>
            <div className="mt-4 flex flex-wrap gap-2">
              <input
                ...
                readOnly
                value={credentialUrl}
                className="min-w-0 flex-1 rounded-lg border border-neutral-300 bg-neutral-50 px-3 py-2 text-xs text-neutral-600 dark:border-neutral-600 dark:bg-neutral-800 dark:text-neutral-300"
              />
              <button
                type="button"
                onClick={handleCopyUrl}
                className="shrink-0 rounded-lg bg-neutral-900 px-4 py-2 text-sm font-medium text-white hover:bg-neutral-700 dark:bg-orange-600 dark:hover:bg-orange-500"
              >
